...
const contactLinks = [
  {
    ...
    color: "bg-indigo-50 border-indigo-200 hover:bg-indigo-100 text-primary",
  },
  {
    label: "Phone",
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/srujangv",
  ...
  },
  {
    ...
    color: "bg-slate-100 border-slate-200 hover:bg-slate-200 text-slate-700",
  },
];
    ...
    <section id="contact" className="py-24 relative">
      <div className="max-w-6xl mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-primary to-accent rounded mb-4" />
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-2xl">
            {contactLinks.map((link, i) => (
              <a
                ...
                className={`group flex items-center gap-4 p-5 rounded-xl border transition-all duration-300 glow-hover ${link.color} ${
                  visible
